# assets.py
# File untuk membuat atau memuat aset visual non-karakter

import pygame
from settings import *

def create_platform_surface(width, height, dimension):
    """Membuat surface untuk platform."""
...
def create_trap_surface(width, height):
    """Membuat surface untuk jebakan duri."""
...
def create_door_surface(width, height):
    """Membuat surface untuk pintu keluar."""
    surface = pygame.Surface((width, height))
    surface.fill((139, 69, 19)) # Coklat
    pygame.draw.circle(surface, (255, 223, 0), (int(width*0.8), int(height/2)), 5)
    return surface

def create_heart_surface():
    """Membuat surface untuk ikon hati."""
...
def scale_surface(surface, scale_factor):
    """Memperbesar sebuah surface dengan faktor skala tertentu."""
