...
- F/f  : Titik muncul musuh pengejar. Arah hadap berdasarkan huruf (F→kanan, f→kiri).
  ...
  (Tidak ada lagi e/E): Gunakan H/h untuk semua musuh patroli.
...
- k/K  : Batas kanan kamera opsional (mengatur penjepit agar kamera tidak akan bergulir lebih jauh ke kanan dari tengah tile ini).
